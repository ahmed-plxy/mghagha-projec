...
function create({ userId, categoryId, name, slug, description, price, listingAttributes }) {
  const result = db.prepare(`
    INSERT INTO personal_listings (user_id, category_id, name, slug, description, price, listing_attributes)
    VALUES (?, ?, ?, ?, ?, ?, ?)
  `).run(
    userId,
    categoryId || null,
