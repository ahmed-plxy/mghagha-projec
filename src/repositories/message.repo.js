...
function create(conversationId, senderId, body) {
  db.prepare('INSERT INTO messages (conversation_id, sender_id, body, is_read) VALUES (?, ?, ?, 0)')
...
module.exports = { findByConversation, create, markConversationRead, countUnreadForUser };
